...
1️.Inisialisasi Fungsi Modular
Program mendefinisikan fungsi power_mod yang menggunakan metode Square and Multiply untuk menghitung perpangkatan dalam sistem modulo secara efisien.
...
5.Pembentukan Shared Secret
Kedua pihak menghitung kunci rahasia bersama:
...
6.Verifikasi Akhir
Program membandingkan hasil shared secret dari kedua sisi. Jika nilainya sama, maka pertukaran kunci berhasil.
...
Instruksi Menjalankan
  ...
  2. Navigasikan ke direktori tempat file difflehellmancode.py disimpan.
